...
moq: ## Generate mock
	# サービスのモック生成
	moq -out ./handler/moq_test.go ./handler RegisterUserService RegisterTemporaryUserService SigninService GetUsersService UpdatePasswordService UpdateAccountService ResetPasswordService SendPointService SignoutService GetAccountService RegisterTemporaryEmailService
	# リポジトリのモック生成
